...
public class Constants {
    ...
    public static class Player{
        ...
        */
        ...
        public static final float UNSCALED_WIDTH = 30, UNSCALED_HEIGHT = 30;
        public static final float INIT_X = 825, INIT_Y= 240;
        public static final float SCALE = 0.83333333333f;//0.1171875f
